...
- [#4353](https://github.com/graphql/graphiql/pull/4353) [`a5fbe57`](https://github.com/graphql/graphiql/commit/a5fbe5702bacc83c5f0b124ddf05707921b710a0) Thanks [@trevor-scheer](https://github.com/trevor-scheer)! - Fix `@graphiql/react` type error: the transport hooks `wrap()` and its test mocks now satisfy the stricter `Transport` type (which requires `url`, `method`, and `supportedMethods`).
